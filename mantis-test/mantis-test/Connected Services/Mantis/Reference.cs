...
namespace mantis_test.Mantis
{
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.SoapTypeAttribute(Namespace = "http://futureware.biz/mantisconnect")]
    public partial class ProjectData : object, System.ComponentModel.INotifyPropertyChanged, IComparable<ProjectData>, IEquatable<ProjectData>
    {
        ...
        public int CompareTo(ProjectData other)
        {
            if (ReferenceEquals(other, null))
                return 1;
            return String.Compare((nameField + descriptionField + view_state.name + status.name ),
                other.nameField + other.descriptionField + other.view_state.name + other.status.name , StringComparison.Ordinal);
        }
        ...
        public bool Equals(ProjectData other)
        {
            ...
            return nameField == other.nameField &&
                   descriptionField == other.descriptionField &&
                   view_state.name == other.view_state.name &&
                   status.name == other.status.name;
        }
    }
